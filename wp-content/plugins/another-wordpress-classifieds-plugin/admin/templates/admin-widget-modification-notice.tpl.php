<div id="widget-modification-notice" class="update-nag clearfix awpcp-sticky-notice">
    <p><?php _e('Thank you for using AWP Classifieds Plugin.', 'another-wordpress-classifieds-plugin'); ?>
    <p><?php _e('AWPCP 3.0 includes several modifications to the <strong>Search Ads</strong>, <strong>Featured Ads</strong> and <strong>Latest Ads</strong> widgets. For example, the Latest Ads widget can now be used in multiple sidebars. Also, there is a new Widget to show Random Ads.', 'another-wordpress-classifieds-plugin'); ?></p>
